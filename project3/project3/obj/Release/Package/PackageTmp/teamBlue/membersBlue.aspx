<%@ Page Title="" Language="C#" MasterPageFile="~/Project3.Master" AutoEventWireup="true" CodeBehind="membersBlue.aspx.cs" Inherits="project3.teamBlue.membersBlue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">
    <asp:GridView ID="gvBlue" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" PageSize="5" SelectedIndex="0" AllowPaging="True" AllowSorting="True" BackColor="#0066FF" DataKeyNames="weapon">
        <Columns>
            <asp:CommandField ShowSelectButton="True" />
            <asp:BoundField DataField="weapon" HeaderText="weapon" SortExpression="weapon" />
        </Columns>
    </asp:GridView>
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="id" DataSourceID="SqlDataSource2" Height="50px" Width="125px" BackColor="#999999" ForeColor="#000099">
        <Fields>
